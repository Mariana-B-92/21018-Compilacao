...
class MOCPListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MOCPParser#prototypeParameters.
    def enterPrototypeParameters(self, ctx:MOCPParser.PrototypeParametersContext):
        pass

    # Exit a parse tree produced by MOCPParser#prototypeParameters.
    def exitPrototypeParameters(self, ctx:MOCPParser.PrototypeParametersContext):
        pass


    # Enter a parse tree produced by MOCPParser#defParameters.
    def enterDefParameters(self, ctx:MOCPParser.DefParametersContext):
        pass

    # Exit a parse tree produced by MOCPParser#defParameters.
    def exitDefParameters(self, ctx:MOCPParser.DefParametersContext):
        pass


    # Enter a parse tree produced by MOCPParser#parameterPrototype.
    def enterParameterPrototype(self, ctx:MOCPParser.ParameterPrototypeContext):
        pass

    # Exit a parse tree produced by MOCPParser#parameterPrototype.
    def exitParameterPrototype(self, ctx:MOCPParser.ParameterPrototypeContext):
        pass


    # Enter a parse tree produced by MOCPParser#parameterDef.
    def enterParameterDef(self, ctx:MOCPParser.ParameterDefContext):
        pass

    # Exit a parse tree produced by MOCPParser#parameterDef.
    def exitParameterDef(self, ctx:MOCPParser.ParameterDefContext):
        pass
