...
class MOCPVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MOCPParser#prototypeParameters.
    def visitPrototypeParameters(self, ctx:MOCPParser.PrototypeParametersContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MOCPParser#defParameters.
    def visitDefParameters(self, ctx:MOCPParser.DefParametersContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MOCPParser#parameterPrototype.
    def visitParameterPrototype(self, ctx:MOCPParser.ParameterPrototypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MOCPParser#parameterDef.
    def visitParameterDef(self, ctx:MOCPParser.ParameterDefContext):
        return self.visitChildren(ctx)
